    ...
    <>
      <div className="flex flex-col items-center justify-center text-center"> 
        ...
        <div className="my-4 space-y-5 p-4">
          ...
          <div className="font-semibold">SynthSpells – AI spells your vibe into sound.</div>
        </div>

        {/* input field */}
        <div className="flex items-center justify-center w-full max-w-1/2 mx-4 mt-6">
          <Textarea className="h-40" placeholder="Summon your perfect playlist with just a prompt." />      
        </div>
      </div>
    </>
  )
